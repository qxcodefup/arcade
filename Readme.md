...
- [Operações Básicas ](#operações-básicas-)
  - [Operações: impressão formatada ](#operações-impressão-formatada-)
  - [Operações: Biblioteca Math ](#operações-biblioteca-math-)
- [Seleção ](#seleção-)
  - [Seleção: Manipulação ](#seleção-manipulação-)
  - [Seleção: Biblioteca Math ](#seleção-biblioteca-math-)
  - [Seleção: Lógica ](#seleção-lógica-)
  - [Seleção: Operador de módulo ](#seleção-operador-de-módulo-)
  - [Seleção: Listas circulares ](#seleção-listas-circulares-)
  - [Seleção: Intervalos ](#seleção-intervalos-)
  - [Seleção: Busca e Contagem ](#seleção-busca-e-contagem-)
  - [Seleção: Conversão ](#seleção-conversão-)
- [Repetição ](#repetição-)
  - [Repetição: Básico ](#repetição-básico-)
