...
- [Caminho Base](#caminho-base)
  ...
  - [Base - Seleção - Introdução](#base---seleção---introdução)
  - [Base - Seleção - Lógica](#base---seleção---lógica)
  - [Base - Seleção - Módulo](#base---seleção---módulo)
  - [Base - Repetição - Básica](#base---repetição---básica)
  - [Base - Repetição - Técnicas de Controle](#base---repetição---técnicas-de-controle)
- [Fundamentos](#fundamentos)
  - [Operações: extra](#operações-extra)
  - [Seleção: Lógica](#seleção-lógica)
  - [Seleção: Operador de módulo](#seleção-operador-de-módulo)
  - [Seleção: Busca, Contagem, Conversão](#seleção-busca-contagem-conversão)
  - [Repetição: Técnicas de controle](#repetição-técnicas-de-controle)
  - [Repetição: Math](#repetição-math)
- [Vetores](#vetores)
  - [Vetores: Busca](#vetores-busca)
  - [Vetores: Contagem](#vetores-contagem)
  - [Vetores: Conversão](#vetores-conversão)
  - [Vetores: Manipulação](#vetores-manipulação)
  - [Vetores: Proximidade](#vetores-proximidade)
  - [Vetores: Ordenação](#vetores-ordenação)
  - [Vetores: Lógica](#vetores-lógica)
  - [Vetores: Math](#vetores-math)
- [Strings](#strings)
  - [Strings I](#strings-i)
  - [Strings II](#strings-ii)
  - [Strings III](#strings-iii)
  - [Strings IV](#strings-iv)
  - [Strings V](#strings-v)
  - [Strings VI](#strings-vi)
- [Matrizes](#matrizes)
...
### Base - Seleção - Introdução<!-- @main_sel +sel:10 -->
...
### Base - Seleção - Módulo<!-- @main_sel_mod +sel:10 -->
...
### Base - Repetição - Básica<!-- @main_rep +rep:15 -->
...
### Seleção: Lógica<!-- @selecao_logica r:main_sel +sel:10 -->
...
### Seleção: Operador de módulo<!-- @selecao_modulo r:selecao_logica +sel:10 -->
...
### Seleção: Busca, Contagem, Conversão<!-- @selecao_busca r:selecao_modulo +sel:10 -->
...
### Repetição: Técnicas de controle<!-- @laco_controle r:main_rep +rep:15 -->
...
```txt
- Vetores: declaração, inicialização, manipulação
- Vetores: busca, contagem, conversão
...
```txt  
- Strings: declaração, inicialização, manipulação
